...
export class InMemoryDataService implements InMemoryDbService {
  createDb() {
    ...
    const outputPort31 = { key: 'postgresql_historic_getafe_sensors', sink: 'PostgreSQL table', metadata_link: 'http://localhost:5000/table_detail/test/postgres/public/accounts2'};
    const outputPort32 = { key: 'api_historic_getafe_sensors', sink: 'API REST endpoint', metadata_link: 'http://localhost:5000/table_detail/test/postgres/public/accounts2'};
    const outputPort41 = { key: 'postgresql_finance_table', sink: 'PostgreSQL table', metadata_link: 'http://localhost:5000/table_detail/test/postgres/public/accounts2'};
    const outputPort42 = { key: 'elasticsearch_finance_index', sink: 'Elasticsearch index', metadata_link: 'http://localhost:5000/table_detail/test/postgres/public/accounts2'};
    const dataproducts = [
